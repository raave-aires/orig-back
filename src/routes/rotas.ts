...
// variáveis:
export const rotas: Router = express.Router();

// middlewares:
rotas.use('/style', express.static(path.join(__dirname, '../../public/style/output.css'))); // middleware para servir estilos junto da pagina html
...
rotas.get('/visualizar', async (req: Request, res: Response) => {
  try {
...
rotas.get('/:numero_do_contrato', async (req: Request, res: Response) => {
  try {
